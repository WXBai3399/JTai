function SnowStorm() {
    ...
    this.flakesMax = 128, this.flakesMaxActive = 64, this.animationInterval = 33, this.flakeBottom = null, this.targetElement = null, this.followMouse = !0, this.snowColor = "#fff", this.snowCharacter = "&bull;", this.snowStick = !0, this.useMeltEffect = !0, this.useTwinkleEffect = !1, this.usePositionFixed = !1, this.flakeLeftOffset = 0, this.flakeRightOffset = 0, this.flakeWidth = 8, this.flakeHeight = 8, this.vMaxX = 5, this.vMaxY = 4, this.zIndex = 0;
    var d = "undefined" == typeof window.attachEvent ? function (a, b, c) {
            return a.addEventListener(b, c, !1)
        } : function (a, b, c) {
            return a.attachEvent("on" + b, c)
        },
        e = "undefined" == typeof window.attachEvent ? function (a, b, c) {
    ...
    this.randomizeWind = function () {
        if (s = b(a(f.vMaxX, .2)), t = a(f.vMaxY, .2), this.flakes)
            for (var c = 0; c < this.flakes.length; c++) this.flakes[c].active && this.flakes[c].setVelocities()
        ...
        var f = this,
            g = b;
        this.type = c, this.x = d || parseInt(a(o - 20), 10), this.y = isNaN(e) ? -a(q) - 12 : e, this.vX = null, this.vY = null, this.vAmpTypes = [1, 1.2, 1.4, 1.6, 1.8], this.vAmp = this.vAmpTypes[this.type], this.melting = !1, this.meltFrameCount = g.meltFrameCount, this.meltFrames = g.meltFrames, this.meltFrame = 0, this.twinkleFrame = 0, this.active = 1, this.fontSize = 10 + this.type / 5 * 10, this.o = document.createElement("div"), this.o.innerHTML = g.snowCharacter, this.o.style.color = g.snowColor, this.o.style.position = x ? "fixed" : "absolute", this.o.style.width = g.flakeWidth + "px", this.o.style.height = g.flakeHeight + "px", this.o.style.fontFamily = "arial,verdana", this.o.style.overflow = "hidden", this.o.style.fontWeight = "normal", this.o.style.zIndex = g.zIndex, z.appendChild(this.o), this.refresh = function () {
            ...
            f.vX >= 0 && f.vX < .2 ? f.vX = .2 : f.vX < 0 && f.vX > -.2 && (f.vX = -.2), f.vY >= 0 && f.vY < .2 && (f.vY = .2)
        }, this.move = function () {
            var a = f.vX * u;
            ...
            f.vX = s + a(.12 * g.vMaxX, .1), f.vY = t + a(.12 * g.vMaxY, .1)
            ...
            f.o.style.display = "none", f.o.style.position = x ? "fixed" : "absolute", f.o.style.bottom = "auto", f.setVelocities(), f.vCheck(), f.meltFrame = 0, f.melting = !1, f.setOpacity(f.o, 1), f.o.style.padding = "0px", f.o.style.margin = "0px", f.o.style.fontSize = f.fontSize + "px", f.o.style.lineHeight = g.flakeHeight + 2 + "px", f.o.style.textAlign = "center", f.o.style.verticalAlign = "baseline", f.x = parseInt(a(o - g.flakeWidth - 20), 10), f.y = parseInt(-1 * a(q), 10) - g.flakeHeight, f.refresh(), f.o.style.display = "block", f.active = 1
        ...
        f.randomizeWind(), f.createSnow(f.flakesMax), d(window, "resize", f.resizeHandler), d(window, "scroll", f.scrollHandler), j || (d(window, "blur", f.freeze), d(window, "focus", f.resume)), f.resizeHandler(), f.scrollHandler(), f.followMouse && d(document, "mousemove", f.mouseMove), f.animationInterval = Math.max(20, f.animationInterval), f.timerInit()
    };
    var B = !1;
    this.start = function (a) {
        ...
        f.targetElement || (f.targetElement = h ? document.body : document.documentElement ? document.documentElement : document.body), f.targetElement != document.documentElement && f.targetElement != document.body && (f.resizeHandler = f.resizeHandlerAlt), f.resizeHandler(), f.usePositionFixed = f.usePositionFixed && !n, x = f.usePositionFixed, o && q && !f.disabled && (f.init(), f.active = !0)
...
var snowStorm = null;
snowStorm = new SnowStorm, $(function () {
    var a = {},
    ...
    a.step1 = function () {
        var c = $(".j-bottomBg"),
            d = $(".j-stars");
        c.addClass("opacity1 fadeIn"), setTimeout(function () {
        ...
        var c = $(".j-tree-left"),
            d = $(".j-tree-right"),
            e = $(".j-bag");
        e.addClass("opacity1 rubberBand").one(b, a.step3), setTimeout(function () {
        ...
        var c = $(".j-gift1"),
            d = $(".j-gift2"),
            e = $(".j-gift3");
        c.addClass("opacity1 bounceInDown"), setTimeout(function () {
    ...
    var d = {},
        e = $(".loading-mask"),
        f = ISPRO ? "dist" : "src";
    d.imgs = [f + "/images/car.png", f + "/images/bg_bottom.png", f + "/images/sprite_bigSnow.png", f + "/images/stars.png", f + "/images/tree.png", f + "/images/bag.png", f + "/images/sprite_gifts.png", f + "/images/glove.png", f + "/images/banner.png"], d.loadedPer = 0, d.eachItemPer = 100 / d.imgs.length, d.doLoadImg = function (a) {
        var b = new Image;
        b.src = a, b.onload = function () {
            d.loadedPer += d.eachItemPer, e.find(".progres-bar").css("width", d.loadedPer + "%").one(c, function () {
